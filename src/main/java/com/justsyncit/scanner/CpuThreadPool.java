...
public class CpuThreadPool extends ManagedThreadPool {
    ...
    public CpuThreadPool(ThreadPoolConfiguration.PoolConfig poolConfig,
        ...
        this.affinityCores = poolConfig.getAffinityCores();
    ...
    protected BlockingQueue<Runnable> createWorkQueue() {
        // CPU operations benefit from smaller queues to prevent over-commitment
        return new LinkedBlockingQueue<>(Math.max(100, poolConfig.getQueueCapacity()));
    }
    
    @Override
    protected ThreadFactory createThreadFactory() {
        return new CpuThreadFactory(poolConfig.getThreadNamePrefix(), 
    ...
    protected RejectedExecutionHandler createRejectionHandler() {
        // For CPU operations, prefer abort to prevent resource exhaustion
