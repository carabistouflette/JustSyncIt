...
/**
 * Enhanced interface for file hashing operations with comprehensive error
 * handling,
 * thread safety guarantees, and performance optimization features.
 *
 * <p>
 * Implementations of this interface must be thread-safe and should handle
 * resource
 * management properly. The interface provides both synchronous and asynchronous
 * methods
 * for file hashing, along with progress reporting and cancellation
 * capabilities.
 * </p>
 *
 * <p>
 * All implementations should validate file paths to prevent security
 * vulnerabilities
 * and should enforce reasonable resource limits to prevent resource exhaustion
 * attacks.
 * </p>
 *
 * <p>
 ...
 * focused
 * methods for different use cases while maintaining a cohesive API.
 * </p>
 */
public interface FileHasher {
         ...
         *                                  file
         * @throws IllegalArgumentException if the file path is invalid or file doesn't
         *                                  exist
         * @throws SecurityException        if the file path violates security
         *                                  constraints
         * @throws HashingException         if hashing fails due to algorithm-specific
         *                                  issues
         */
        String hashFile(Path filePath)
         ...
         *
         * @param filePath the path to the file to hash, must not be null
         * @return a CompletableFuture that completes with the hash as a hexadecimal
         *         string
         ...
         *
         * @param filePath         the path to the file to hash, must not be null
         * @param progressCallback consumer that receives progress updates (0.0 to 1.0),
         *                         may be null
         * @return the hash as a hexadecimal string, never null
         * @throws IOException              if an I/O error occurs while reading the
         *                                  file
         ...
         * @param expectedHash the expected hash value as a hexadecimal string, must not
         *                     be null
         ...
         * Implementations must be thread-safe if they are to be used by multiple
         * threads.
         */
