 ...
 * for various use cases including large file processing and streaming data.
 * </p>
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Implementations MUST be thread-safe for concurrent hashing of different
 * streams</li>
 * <li>Individual stream hashing operations should not interfere with each
 * other</li>
 ...
 * </p>
 * <ul>
 * <li>Input streams are never closed by implementations - callers retain
 * ownership</li>
 * <li>Implementations should properly manage internal resources (buffers,
 * native handles)</li>
 * <li>Large streams should be processed incrementally to avoid memory
 * exhaustion</li>
 * </ul>
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Implementations should use appropriate buffer sizes for optimal I/O
 * performance</li>
...
public interface StreamHasher {
         ...
         *
         * @param inputStream the input stream to hash, must not be null
         * @param offset      the starting offset in the stream (bytes to skip), must be
         *                    >= 0
         * @param length      the number of bytes to hash (0 means until end of stream),
         *                    must be >= 0
         * @return the hash as a hexadecimal string, never null
         * @throws IOException              if an I/O error occurs while reading from
         *                                  the stream
         ...
         *
         * @param inputStream      the input stream to hash, must not be null
         * @param offset           the starting offset in the stream (bytes to skip),
         *                         must be >= 0
         * @param length           the number of bytes to hash (0 means until end of
         *                         stream), must be >= 0
         * @param progressListener optional listener for progress updates (can be null)
         * @return the hash as a hexadecimal string, never null
         * @throws IOException              if an I/O error occurs while reading from
         ...
         * Implementations should handle exceptions thrown by listener methods
         * gracefully.
         */
        interface HashProgressListener {
                 ...
                 *
                 * @param bytesProcessed the number of bytes processed before the error, must be
                 *                       >= 0
