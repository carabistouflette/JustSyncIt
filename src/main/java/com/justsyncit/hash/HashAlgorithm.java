 ...
 *
 * <p>
 * This interface provides a contract for different hash algorithms to follow,
 ...
 * <li>If not thread-safe, implementations MUST provide a createInstance()
 * method for concurrent use</li>
 * <li>Thread-safe implementations MUST use appropriate synchronization
 * mechanisms</li>
 * </ul>
 *
 * <p>
 ...
 * <li>IllegalStateException MUST be thrown when the algorithm is in an invalid
 * state</li>
 ...
 * <li>Implementations SHOULD be resistant to timing attacks where
 * applicable</li>
...
public interface HashAlgorithm extends Closeable {
     ...
     * @throws IllegalStateException    if the algorithm has been finalized (digest
     *                                  called)
     ...
     * @throws HashingException         if verification fails due to
     ...
     * @throws HashingException              if an algorithm-specific error occurs
     * @throws UnsupportedOperationException if the algorithm doesn't support
    ...
    default void close() throws IOException {
        // Default implementation does nothing - algorithms without resources can skip
        // this
    }
}