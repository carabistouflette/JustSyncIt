...
import com.justsyncit.network.quic.tls.CertificateGenerationException;
...
public class QuicTlsConfiguration {
    ...
    private QuicTlsConfiguration(Builder builder) {
        ...
        this.cipherSuites = Collections.unmodifiableList(
                Objects.requireNonNull(builder.cipherSuites, "cipherSuites cannot be null"));
        this.applicationProtocols = Collections.unmodifiableList(
                Objects.requireNonNull(builder.applicationProtocols, "applicationProtocols cannot be null"));
        this.serverCertificates = Collections.unmodifiableList(
                Objects.requireNonNull(builder.serverCertificates, "serverCertificates cannot be null"));
        this.serverPrivateKey = Objects.requireNonNull(builder.serverPrivateKey, "serverPrivateKey cannot be null");
        this.clientCertificates = Collections.unmodifiableList(
                Objects.requireNonNull(builder.clientCertificates, "clientCertificates cannot be null"));
        this.clientPrivateKey = builder.clientPrivateKey;
        this.trustedCertificates = Collections.unmodifiableList(
                Objects.requireNonNull(builder.trustedCertificates, "trustedCertificates cannot be null"));
        ...
        this.sessionTicketLifetime = Objects.requireNonNull(builder.sessionTicketLifetime,
                "sessionTicketLifetime cannot be null");
    ...
    public static class Builder {
        ...
        /** Enable session resumption flag. */
        private boolean enableSessionResumption = true;
        /** Enable zero RTT flag. */
        ...
        public Builder applicationProtocols(List<String> applicationProtocols) {
            this.applicationProtocols = Objects.requireNonNull(applicationProtocols,
                    "applicationProtocols cannot be null");
            return this;
        }
        ...
        public Builder serverCertificates(List<X509Certificate> serverCertificates) {
            this.serverCertificates = Objects.requireNonNull(serverCertificates,
                    "serverCertificates cannot be null");
            return this;
        }
        ...
        public Builder trustedCertificates(List<X509Certificate> trustedCertificates) {
            this.trustedCertificates = Objects.requireNonNull(trustedCertificates,
                    "trustedCertificates cannot be null");
            return this;
        }
        ...
        public Builder sessionTicketLifetime(Duration sessionTicketLifetime) {
            this.sessionTicketLifetime = Objects.requireNonNull(sessionTicketLifetime,
                    "sessionTicketLifetime cannot be null");
            return this;
        }
