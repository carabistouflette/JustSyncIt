...
public class ServiceFactory {
     ...
     */
    public JustSyncItApplicationRefactored createApplication() {
        ...
        return new JustSyncItApplicationRefactored(blake3Service, commandRegistry, infoDisplay);
    }
    ...
    private Blake3Service createBlake3Service() {
        ...
        return new Blake3ServiceRefactored(
