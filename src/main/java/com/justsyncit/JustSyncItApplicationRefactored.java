 ...
 */
public class JustSyncItApplicationRefactored {

    private static final Logger logger = LoggerFactory.getLogger(JustSyncItApplicationRefactored.class);
     ...
     */
    public JustSyncItApplicationRefactored(
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            JustSyncItApplicationRefactored app = serviceFactory.createApplication();
            app.run(args);
        } catch (Exception e) {
