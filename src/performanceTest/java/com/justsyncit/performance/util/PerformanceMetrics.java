 ...
 * Provides standardized measurement methods for various performance characteristics.
 */
public class PerformanceMetrics {
    ...
    public String generateSummary() {
        ...
        if (metrics.containsKey("deduplication_ratio")) {
            sb.append("Deduplication Ratio: ").append(String.format("%.2f", metrics.get("deduplication_ratio"))).append("x\n");
        }
        
        if (metrics.containsKey("space_savings_percent")) {
            sb.append("Space Savings: ").append(String.format("%.1f", metrics.get("space_savings_percent"))).append("%\n");
        }
    ...
    private CpuMeasurement measureCpu() {
        ...
        try {
            ...
            try {
                ...
                if (usagePercent < 0) usagePercent = 0.0; // Can return -1 on some systems
            } catch (ClassCastException e) {
                // Fallback to system CPU load
                usagePercent = osBean.getSystemLoadAverage();
                if (usagePercent < 0) usagePercent = 0.0;
            }
    ...
    public static class MemoryUsage {
        ...
        public long getMemoryUsed() { return after.usedBytes - before.usedBytes; }
        public long getMaxMemoryUsed() { return after.maxBytes - before.maxBytes; }
        public MemoryMeasurement getBefore() { return before; }
        public MemoryMeasurement getAfter() { return after; }
    }
    ...
    public static class CpuUsage {
        ...
        public double getCpuUsed() { return after.usagePercent - before.usagePercent; }
        public CpuMeasurement getBefore() { return before; }
        public CpuMeasurement getAfter() { return after; }
    }
}