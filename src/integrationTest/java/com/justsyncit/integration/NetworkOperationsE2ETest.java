...
public class NetworkOperationsE2ETest extends E2ETestBase {
    ...
    protected void setUp() throws Exception {
        ...
        startCommand = new ServerStartCommand(networkService);
        stopCommand = new ServerStopCommand(networkService);
        statusCommand = new ServerStatusCommand(networkService);
    ...
    void testServerStartAndStop() throws Exception {
        ...
        boolean startResult = serverCommand.execute(new String[]{"start", "--port", String.valueOf(port)}, commandContext);
    ...
    void testServerStartWithCustomPort() throws Exception {
        ...
        int customPort = 9999;
        boolean result = serverCommand.execute(new String[]{"start", "--port", String.valueOf(customPort)}, commandContext);
    ...
    void testServerStartWithTransportType() throws Exception {
        ...
        testWithBothTransports(transportType -> {
            ...
            assertEquals(port, networkService.getServerPort(), "Server should be listening on correct port with " + transportType);
    ...
    void testFileTransfer() throws Exception {
        ...
        InetSocketAddress remoteAddress = new InetSocketAddress("localhost", findAvailablePort());
    ...
    void testConcurrentNetworkOperations() throws Exception {
        ...
        boolean startResult1 = serverCommand.execute(new String[]{"start", "--port", String.valueOf(port1)}, commandContext);
        boolean startResult2 = serverCommand.execute(new String[]{"start", "--port", String.valueOf(port2)}, commandContext);
        ...
        assertTrue(networkService.isServerRunning(), "At least one server should be running");
        
        // Test operations on multiple servers
        // In a real test, we would test concurrent operations
        // For now, we verify the infrastructure supports multiple servers
        ...
        // Start second server and stop it
        boolean startResult3 = serverCommand.execute(new String[]{"start", "--port", String.valueOf(port2)}, commandContext);
        assertTrue(startResult3, "Second server start should succeed");
